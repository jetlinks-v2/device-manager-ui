  ...
  return createAiClientToolRuntime<DeviceClientToolContext>(
    ...
    createDevicePropertyAggregateTool({
      ...
      copy: {
        ...
        startTime: t('DeviceDetail.agentTools.propertyAggregate.inputs.startTime'),
        endTime: t('DeviceDetail.agentTools.propertyAggregate.inputs.endTime'),
        timeRange: t('DeviceDetail.agentTools.propertyAggregate.inputs.timeRange'),
