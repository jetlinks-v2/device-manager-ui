      ...
      <div style="height: 350px; overflow-y: auto" v-if="showContent">
        <a-collapse v-model:activeKey="activeKey" v-if="visible">
          ...
          <a-collapse-panel key="extra" v-if="showExtra || showExtraFile"
            ...
            <!--                        <template #header>-->
            <!--                            <a-space>-->
            <!--                                <div>{{ $t('Properties.OtherSetting.237457-28') }}</div>-->
            <!--&lt;!&ndash;                                <template&ndash;&gt;-->
            <!--&lt;!&ndash;                                    v-if="&ndash;&gt;-->
            <!--&lt;!&ndash;                                        props.isProduct && target === 'device'&ndash;&gt;-->
            <!--&lt;!&ndash;                                    "&ndash;&gt;-->
            <!--&lt;!&ndash;                                >&ndash;&gt;-->
            <!--&lt;!&ndash;                                    <a-button&ndash;&gt;-->
            <!--&lt;!&ndash;                                        type="link"&ndash;&gt;-->
            <!--&lt;!&ndash;                                        style="padding: 0 4px; height: 22px"&ndash;&gt;-->
            <!--&lt;!&ndash;                                        @click="(e) => resetThreshold(e)"&ndash;&gt;-->
            <!--&lt;!&ndash;                                    >&ndash;&gt;-->
            <!--&lt;!&ndash;                                        <template #icon>&ndash;&gt;-->
            <!--&lt;!&ndash;                                            <AIcon type="RedoOutlined" />&ndash;&gt;-->
            <!--&lt;!&ndash;                                        </template>&ndash;&gt;-->
            <!--&lt;!&ndash;                                        {{ $t('Properties.OtherSetting.237457-4') }}&ndash;&gt;-->
            <!--&lt;!&ndash;                                    </a-button>&ndash;&gt;-->
            <!--&lt;!&ndash;                                    <a-tooltip>&ndash;&gt;-->
            <!--&lt;!&ndash;                                        <template #title&ndash;&gt;-->
            <!--&lt;!&ndash;                                            >{{ $t('Properties.OtherSetting.237457-5') }}</template&ndash;&gt;-->
            <!--&lt;!&ndash;                                        >&ndash;&gt;-->
            <!--&lt;!&ndash;                                        <AIcon type="QuestionCircleOutlined" />&ndash;&gt;-->
            <!--&lt;!&ndash;                                    </a-tooltip>&ndash;&gt;-->
            <!--&lt;!&ndash;                                </template>&ndash;&gt;-->
            <!--&lt;!&ndash;                                <a-button&ndash;&gt;-->
            <!--&lt;!&ndash;                                    v-else&ndash;&gt;-->
            ...
            <!--&lt;!&ndash;                                        <AIcon type="RedoOutlined" />&ndash;&gt;-->
            <!--&lt;!&ndash;                                    </template>&ndash;&gt;-->
            <!--&lt;!&ndash;                                    {{ $t('Properties.OtherSetting.237457-6') }}&ndash;&gt;-->
            <!--&lt;!&ndash;                                </a-button>&ndash;&gt;-->
            <!--                            </a-space>-->
            <!--                        </template>-->
            <CardItem
            ...
            <div style="margin-top: 16px" v-if="showExtraFile">
              <CardItem @change="onFileChange" :value="show.file" :title="$t('Properties.OtherSetting.237457-30')"
