...
import { createDeviceLibraryMockAdapter } from '@device-manager-ui/views/device/shared/device-library/services/adapters/deviceLibraryMockAdapter'
import type { AddToProjectInput, AdapterGroup, DeviceLibraryAdapter, DeviceTemplate } from '@device-manager-ui/views/device/shared/device-library/services/types'
