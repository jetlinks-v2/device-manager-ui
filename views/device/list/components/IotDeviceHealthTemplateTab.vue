<template>
  <div class="health-template-tab">
    <section class="health-card">
      ...
      <CloudEmpty v-else class="health-empty" :description="$t('IotDeviceDetail.healthTemplate.noConnection')" />
    </section>
    ...
    <section class="health-card">
      ...
      <div v-if="deviationProperties.length" class="health-list">
        ...
        >
          ...
          <div class="health-meta">
            <div class="health-meta__row">
              <span class="health-meta__label">{{ $t('IotDeviceDetail.healthTemplate.propertyId') }}</span>
            ...
            <div class="health-meta__row">
              <span class="health-meta__label">{{ $t('IotDeviceDetail.healthTemplate.warningRange') }}</span>
              <span class="health-meta__value">{{ property.expandedConfig.deviationConfig.warningRange || '-' }}</span>
            </div>
            <div class="health-meta__row">
              <span class="health-meta__label">{{ $t('IotDeviceDetail.healthTemplate.alarmRange') }}</span>
      ...
      <CloudEmpty v-else class="health-empty" :description="$t('IotDeviceDetail.healthTemplate.noDeviation')" />
    </section>
  </div>
</template>
...
defineProps({
  connectionRules: {
    type: Array as PropType<IotDeviceLibraryConnectionHealthRule[]>,
    required: true,
  },
  deviationProperties: {
