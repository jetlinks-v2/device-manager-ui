...
export type IotDeviceTypeCategory = string
export type IotDeviceTypeIndustry = string
export type IotDeviceTypeProtocol = string
export type IotTemplateParameterValues = Record<string, unknown>
export interface IotTemplateParameterOption {
  label: string
  value: string
}
export interface IotProductTemplate {
  id: string
  name: string
  description?: string
  [key: string]: unknown
...
export interface IotDeviceLibraryQuery {
  ...
  industry: 'all' | IotDeviceTypeIndustry
  protocol: 'all' | IotDeviceTypeProtocol
  category: 'all' | IotDeviceTypeCategory
  brand: string
  page: number
  pageSize: number
}
...
export interface IotDeviceLibraryTemplateCard {
  ...
  brand: string
  model: string
  protocol: IotDeviceTypeProtocol
  category: IotDeviceTypeCategory
  industry: IotDeviceTypeIndustry
  tags: string[]
  version: string
  maintainer: string
  updatedAt: string
...
export interface IotDeviceLibraryJoinInput {
  ...
  templateId: string
  productName: string
  config: IotTemplateParameterValues
}
...
export interface IotDeviceLibraryAdapter {
  ...
  listParameterOptions(
    ...
    templateId: string,
    fieldKey: string,
    values: IotTemplateParameterValues,
  ): Promise<ServiceResult<IotTemplateParameterOption[]>>
}
